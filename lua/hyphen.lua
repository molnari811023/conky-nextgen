-- hyphen.lua - pure Lua hyphenation using LibreOffice .dic patterns
-- Usage:
--   local hyphen = require("hyphen")
--   hyphen.load("/usr/share/hyphen/hyph_hu_HU.dic")
--   local points = hyphen.break_word("asztal")
--   local wrapped = hyphen.insert_hyphens("asztal")
