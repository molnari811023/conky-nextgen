...
--]]
-- 15_hardware_battery.lua — Battery health, Bluetooth headset, mouse battery
...
function is_plasma()
	return cached("is_plasma_env", 3600, function()
		...
		return pread("ps -e | grep plasmashell") ~= ""
	end)
end
...
function get_device_upower(filter)
