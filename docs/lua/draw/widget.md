...
## Purpose
User-defined widget configuration. This is where you define `draw[]` and `layout[]` tables. Every module in the framework is the motor — your `lua/widget.lua` is the steering wheel.
